...
class TestTransferPositiveUI(BaseUITest):
    ...
    def test_deposit_positive(self,page: Page,api_manager,deposit_amount, transfer_amount,invalid_account,user_request: CreateUserRequest):
        # ШАГ 1: логин
