...
class TestTransferNegativeUI(BaseUITest):
    @pytest.mark.usefixtures("user_request", "api_manager")
    def test_deposit_negative(self,page: Page,api_manager,deposit_amount, invalid_amount,user_request: CreateUserRequest):
        # ШАГ 1: логин
