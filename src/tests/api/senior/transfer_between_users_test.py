...
class TestTransferBetweenUsers:
    ...
    def test_transfer_between_users(self, api_manager: ApiManager, user_request_1, user_request_2, deposit_amount, transfer_amount):
        ...
        api_manager.user_steps.deposit_account(user_request_1,account_1.id, amount=deposit_amount)
